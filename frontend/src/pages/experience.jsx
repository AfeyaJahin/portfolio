...
const Experience = () => {
  ...
  const fetchData = async () => {
    try {
      const employmentResponse = await fetch('https://afeyajahinbackend.vercel.app/api/employment');
      const projectsResponse = await fetch('https://afeyajahinbackend.vercel.app/api/projects');
      const leadershipResponse = await fetch('https://afeyajahinbackend.vercel.app/api/leadership');
