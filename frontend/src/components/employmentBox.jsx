...
const EmploymentBox = ({ employment }) => {
  const startDate = formatDate(employment.startDate);
  const endDate = employment.endDate ? formatDate(employment.endDate) : 'Present';
  ...
  return (
    ...
    >
      ...
      <CardMedia
        ...
        image={employment.imageUrl || 'https://static.vecteezy.com/system/resources/previews/005/337/799/original/icon-image-not-found-free-vector.jpg'} // Replace with your fallback image URL
        alt={employment.institution}
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
        ...
        >
          {/* Header with Position, Company, and Date */}
          ...
          <ul style={{ paddingLeft: '20px', marginTop: 0, marginBottom: '16px' }}>
            {employment.description.map((point, index) => (
              <li key={index}>
