...
app.use('/api/education', (req, res, next) => {
  console.log('Education route hit');
  next();
}, educationRoutes);

app.use('/api/employment', (req, res, next) => {
  console.log('Employment route hit');
  next();
}, employmentRoutes);

app.use('/api/leadership', (req, res, next) => {
  console.log('Leadership route hit');
  next();
}, leadershipRoutes);
